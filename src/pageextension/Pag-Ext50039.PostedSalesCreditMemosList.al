pageextension 50039 PostedSalesCreditMemosList extends "Posted Sales Credit Memos"
{
    layout
    {
        ...
        addlast(processing)
        {
            action("Credit Note Report")
            {
                ...
                begin
                    ...
                    Report.RunModal(50129, true, true, shimpmentheader);
