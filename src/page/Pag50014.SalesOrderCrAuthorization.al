...
page 50014 "SalesOrderCr.Authorization"
{
    Caption = 'Sales Order Credit Authorization';
    PageType = Document;
    ApplicationArea = all;
    ...
    layout
    {
        area(content)
        {
            ...
            group(Attributes)
            {
                ...
                field("Customer Ref. No."; Rec."Pending for Delivery (In-Transit)")
                {
                    ApplicationArea = All;
                ...
                action("Send IC Sales Order")
                {
                    ...
                    begin
                        ...
                        if ApprovalsMgmt.PrePostApprovalCheckSales(Rec) then begin
                            ...
                            //  ICFeedback.ShowIntercompanyMessage(Rec, Enum::"IC Transaction Document Type"::Order); //yash CCIT
                        end;
                    end;
                }
            ...
            group("Request Approval")
            {
                ...
                group(Flow)
                {
                    ...
                    customaction(CreateFlowFromTemplate)
                    {
                        ...
                        // Visible = IsSaaS and IsPowerAutomatePrivacyNoticeApproved;//Yash
    ...
    begin
        if not OrderSalesHeader.Get(Rec."Document Type", Rec."No.") then begin
            ...
            if SalesInvoiceHeader.FindFirst() then begin
                // ICFeedback.ShowIntercompanyMessage(Rec, Enum::"IC Transaction Document Type"::Order);//yash
